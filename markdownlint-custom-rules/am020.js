        ...
        if (strippedfm != '') {
            ...
            try {
                ...
                if (!(meta.hasOwnProperty('description'))) {
                    shared.addWarningContext(params.name, 'Metadata', '', module.exports.names[0] + '/' + module.exports.names[1] + ' "description" metadata missing')
                    // shared.addErrorDetailIf(onError, 1, null, '"description" metadata missing', null)

                } else {
                    if (meta['description'] == null) {
                        shared.addWarningContext(params.name, 'Metadata', '', module.exports.names[0] + '/' + module.exports.names[1] + ' invalid "description": ' + meta['description'])
                ...
                if (meta.hasOwnProperty('solution')) {
                    ...
                    if (badcount > 1 ) {
                        ...
                        shared.addErrorDetailIf(onError, 1, null, 'Invalid solutions specified in YAML: ' + badsolutions, null)
                    } else if (badcount == 1) {
                        shared.addErrorDetailIf(onError, 1, null, 'Invalid solution specified in YAML: ' + badsolutions, null)
                    }
                ...
                shared.addErrorDetailIf(onError, 1, null, err.toString().replace('YAMLException: ', ''), null)
            }
