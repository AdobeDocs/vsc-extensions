...
module.exports.alertType = /^>\[!(NOTE|TIP|IMPORTANT|CAUTION|WARNING|ADMIN|AVAILABILITY|PREREQUISITES|VIDEO|MORELIKETHIS)\]/gm; //identify valid alert types (all caps)
module.exports.bracketExclam = /^\[!/gm; //identify syntax beginning with "[!" at the start of a line
module.exports.alertTypeNoOpen = /^\[!(NOTE|TIP|IMPORTANT|CAUTION|WARNING|ADMIN|AVAILABILITY|PREREQUISITES|VIDEO|MORELIKETHIS)\]/gm; //identify attempted alerts not preceded by "> "
module.exports.alertNoExclam = /\[(NOTE|TIP|IMPORTANT|CAUTION|WARNING|ADMIN|AVAILABILITY|PREREQUISITES|VIDEO|MORELIKETHIS)\]/gm; //identify alerts missing !
